...
### 3. Forensic Audit & Convergence Report
...
### 4. Bayesian Foundations: Manual MCMC Sampling
...
*Figure 1: Post-warm-up trace plots for the two treatment effects, four chains. Generated by `MLNMR_Audit_Report.qmd`.*
