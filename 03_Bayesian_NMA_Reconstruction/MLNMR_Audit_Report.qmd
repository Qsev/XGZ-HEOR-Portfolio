...
::: {.callout-tip}
## Technical Asset
This methodological audit is fully reproducible using the engineered R/Stan pipeline (`MLNMR_Pipeline.R`) integrated directly as executable code blocks within this document.
:::
...
knitr::kable(as.data.frame(releff), digits = 3, caption = "Aligned Relative Effects")
```
