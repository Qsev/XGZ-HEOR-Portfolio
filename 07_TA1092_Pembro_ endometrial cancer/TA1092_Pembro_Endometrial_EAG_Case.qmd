...
The table below presents the top three candidate survival distributions for each cohort, ranked by their Akaike Information Criterion (AIC).
...
top3_fit_summary |>
  kable(digits = 2, col.names = c("Subgroup", "Endpoint", "Treatment", "Distribution", "N", "Events", "AIC", "BIC"))
```
