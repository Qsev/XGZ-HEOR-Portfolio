...
3. <span id="issue-3-list">[**Short trial follow-up (Data Immaturity)**](#sec-issue3)</span>: Immaturity of trial data limits the robustness of long-term survival effectiveness conclusions.
...
5. <span id="issue-5-list">[**Uncertain overall survival benefit**](#sec-issue5)</span>: The company's survival models potentially overestimate long-term immunotherapy tail benefits.
...
### OS Tail Sensitivity & Overall Survival Plausibility (Issue 5) {#sec-issue5}
...
([Back to Key Issues List](#issue-5-list))
