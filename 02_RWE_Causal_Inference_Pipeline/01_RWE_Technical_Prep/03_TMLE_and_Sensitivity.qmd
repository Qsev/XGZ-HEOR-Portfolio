...
To address this, doubly robust estimators combine the treatment model with an outcome regression model. For a detailed algebraic proof of the double robustness property, see the [AIPW section in Page 2](./02_PSM_IPTW_AIPW.qmd#sec-aipw):
$$m(D, X) = E[Y \mid D, W]$$
